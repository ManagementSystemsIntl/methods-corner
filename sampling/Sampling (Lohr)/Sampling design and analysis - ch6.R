# Code from Chapter 6 of R Companion for Sampling: Design and Analysis by Yan Lu and Sharon L. Lohr
...
mysample$SamplingWeight <- 1/mysample$ExpectedHits # inverse probability
