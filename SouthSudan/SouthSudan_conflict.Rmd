...
ACLED's conflict event data from South Sudan dates from July 14, 2011. As of April 14, 2022 it includes 8,296 unique conflict events. Using R, it is relatively straightforward to generate a map of South Sudan that shows these conflict events without switching across software platforms. 
...
patch2 <- patchwork::wrap_elements(map_raster - choro_map)
