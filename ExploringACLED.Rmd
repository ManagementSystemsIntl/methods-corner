...
```{r echo=F, fig.cap="The fifteen countries included in ACLED's Western Africa dataset."}
...
```{r echo=F, fig.cap="There were more cases of violence against civilians than any other type of conflict from 1997-2021."}
...
```{r echo=F, fig.cap="Nigeria has the most incidents of conflict while Guinea-Bissau and Gambia have the least."}
...
```{r fig.dim=c(12,13), echo=F, fig.cap="When looking at the distribution of conflict types by country Nigeria has the highest counts in five of the six categories."}
...
```{r, fig.dim = c(10,11), echo=F, fig.cap="Seeing the distribution of conflict over time and country helps us understand the contours of the dataset better."}
