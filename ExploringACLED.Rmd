...
knitr::opts_chunk$set(echo = F, warning = F, message = F, cache = T, error = T)
...
```{r, fig.cap="There were more cases of violence against civilians than any other type of conflict from 1997-2021."}
