...
A brief tutorial on making a map in both tmap and ggplot2. This approaches uses sf for working with vector data to make a static map and an interactive map. 
