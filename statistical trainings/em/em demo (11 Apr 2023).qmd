...
p1_x1 <- .5 # share of component 1, iteration 1
p1_x2 <- .5
...
Given our initial model parameters that each indicator value has a 60 percent probability of belonging to component 1 and a 40 percent probability of belonging to component 2, then we would expect to see the pattern (1-1-1) to be $.6*.6*.6$ = `r .6^3*100`% of the time in component 1, and $.4*.4*.4$ = `r .4^3*100`% of the time in component 2.
...
pnew_x1 <- x1_freqs2 / (x1_freqs2 + x2_freqs2)
pnew_x1

pnew_x2 <- x2_freqs2 / (x1_freqs2 + x2_freqs2)
pnew_x2

y1_x1 <- f1_y1_c1 / x1_freqs2
y1_x1

y2_x1 <- f1_y2_c1 / x1_freqs2
y2_x1

y3_x1 <- f1_y3_c1 / x1_freqs2
y3_x1
